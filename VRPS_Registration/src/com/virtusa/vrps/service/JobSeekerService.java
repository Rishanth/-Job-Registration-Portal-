...
public class JobSeekerService implements IJobSeekerService
{
	...
	public long saveOrUpdate(Skill skill) {
		...
		jobSeekermodel.setSkill(skillSet);
		return iJobSeekerDao.saveOrUpdate(jobSeekermodel);
	}
...
jobSeekermodel.setQualification(qualificationSet);
return iJobSeekerDao.saveOrUpdate(jobSeekermodel);
	}
	...
	{
		com.virtusa.vrps.model.Experience  experienceModel=new com.virtusa.vrps.model.Experience();
		...
		experienceModel.setLastReportingManger(experience.getLastReportingManger());
		experienceModel.setLastReportingManagernumber(experience.getLastReportingManagernumber());
		experienceModel.setRoleDesignation(experience.getRoleDesignation());
		Set<com.virtusa.vrps.model.Experience>experienceSet=new HashSet<com.virtusa.vrps.model.Experience>();
		experienceSet.add(experienceModel);
		jobSeekermodel.setExperience(experienceSet);
		return iJobSeekerDao.saveOrUpdate(jobSeekermodel);
	}
}
